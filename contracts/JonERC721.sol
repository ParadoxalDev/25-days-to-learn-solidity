...
contract JonERC721 is ERC721, Ownable {
     ...
     event stepUdpated(Step currentStep);

     constructor(string memory _baseTokenURI, bytes32 _merkleRoot) ERC721("Paradoxe Collection", "PRDX"){}
     ...
     function updatewhitlistPrice(uint _newPrice) external onlyOwner {
